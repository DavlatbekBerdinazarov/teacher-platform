            ...
            <div className="flex flex-col xl:flex-row justify-between my-1 gap-3">
              <div className="">
                <Input
                  ...
                  type="text"
                  placeholder="Ism"
                  className=" w-full xl:w-[265px] text-lg !border !border-gray-300 bg-white text-gray-900 shadow-lg shadow-gray-900/5 ring-4 ring-transparent placeholder:text-gray-500 placeholder:opacity-100 focus:!border-gray-900 focus:!border-t-gray-900 focus:ring-gray-900/10"
                  labelProps={{
                    className: "hidden",
                  }}
                  containerProps={{
              ...
              <div className="">
                <PatternFormat
                  ...
                  className="h-12 w-full xl:w-[265px] text-lg !border !border-gray-300 bg-white text-gray-900 shadow-lg shadow-gray-900/5 ring-4 ring-transparent placeholder:text-gray-500 placeholder:opacity-100 focus:!border-gray-900 focus:!border-t-gray-900 focus:ring-gray-900/10"
                  onChange={(e) =>
