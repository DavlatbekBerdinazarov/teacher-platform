...
export default function SingleCoursePage() {
  ...
  useEffect(() => {
    axios
      .get(`https://itlive.introdevs.site/api/course-category/single/${id}`)
                ...
                <div className=" col-span-3 lg:col-span-2 ">
                  ...
                  <div className="my-6">
                    ...
                    <p className="hidden md:block">
                      Мы представляем и подбираем курсы в наиболее развитых
                      областях не только в нашей стране, но и по всему миру.Мы
                      представляем и подбираем курсы в наиболее развитых
                      областях не только в нашей стране, но и по всему миру.Мы
                      представляем и подбираем курсы в наиболее развитых
                      областях не только в нашей стране, но и по всему миру.Мы
                      представляем и подбираем курсы в наиболее развитых
                      ...
                      областях не только в нашей стране, но и по всему миру.Мы
                      представляем и подбираем курсы в наиболее развитых
                      областях не только в нашей стране, но и по всему миру.
                    </p>
                    <p className="block lg:hidden">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Veritatis architecto consequuntur praesentium dolorem
                      tenetur porro? Maxime blanditiis similique optio pariatur
                      omnis explicabo autem sequi error odit.
                    </p>
                  </div>
                  ...
                  <div className="min-h-[160px] w-full p-2 sm:p-4 border-2 rounded-xl flex items-start gap-6">
                    ...
                    <div className="w-full">
                      ...
                      <p className=" text-mutedtxt font-medium text-sm">
                        Programmer
                      </p>

                      <p className=" text-mutedtxt font-medium text-sm block lg:hidden">
                        Lorem ipsum dolor, sit amet consectetur adipisicing
                        elit. Labore molestias?
                      </p>
                      <p className=" text-mutedtxt font-medium text-sm mt-2 pb-8 hidden lg:block">
                        Мы представляем и подбираем курсы в наиболее развитых
                        областях не только в нашей стране, но и по всему мируМы
                        представляем и подбираем курсы в наиболее развитых
                        областях не только в нашей стране, но и по всему миру
                      </p>
                    </div>
